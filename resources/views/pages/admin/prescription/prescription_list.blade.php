@extends('layouts.app')
@section('content')
<h1 class="h3 mb-4 text-gray-800">User Prescriptions</h1>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ url('quotation/' . $prescription->id) }}" class="btn btn-dark ml-auto">
                                    <span class="bi bi-plus-square-dotted"></span> Quotation
                                </a>
                            </td>
